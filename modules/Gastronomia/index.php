  ...
  <div role="main" class="ui-content jqm-content">
    ...
    <form method="post" action="detail.php" data-ajax="false">
      <ul data-role="listview" data-inset="true" data-filter="true">
        <?php 
          $gastronomias = $Gastronomia->get_gastronomias();
          while($row = mysqli_fetch_array($gastronomias)){ ?>
          <li>
            <button type="hidden" name="detail_gastronomia" value="<?php echo $row['id_gastronomia'] ?>">
