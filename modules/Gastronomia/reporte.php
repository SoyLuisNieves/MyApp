...
<div data-role="page" class="jqm-demos jqm-panel-page" data-quicklinks="true" data-ajax="false">
  ...
  <div role="main" class="ui-content jqm-content">
    ...
    <h3 align="center">Desea reportar la gastronomia: <?php echo $row['titulo']; ?> -</h3>
      <form method="post" action="reporte.php" data-ajax="false">
        ...
        <input style="display: none" type="number" name="id_post" value="<?php echo $row['id_gastronomia'] ?>">
        ...
        <textarea placeholder="Escribe un comentatio..." name="comentario" cols="30" rows="10"></textarea>
      ...
      <form action="index.php" data-ajax="false">
        <input type="submit" data-icon="delete" data-theme="b" value="Cancelar">
      </form>
  </div><!-- /content -->
