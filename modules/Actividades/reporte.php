...
<div data-role="page" class="jqm-demos jqm-panel-page" data-quicklinks="true" data-ajax="false">
  ...
  <div role="main" class="ui-content jqm-content">
    <?php
        $actividades = $Actividad->get_actividad();
        $row = mysqli_fetch_array($actividades) 
      ?>
          
    <h3 align="center">Desea reportar la actividad: <?php echo $row['titulo']; ?> -</h3>
      <form method="post" action="reporte.php" data-ajax="false">
        ...
        <input style="display: none" type="number" name="id_post" value="<?php echo $row['id_actividad'] ?>">
